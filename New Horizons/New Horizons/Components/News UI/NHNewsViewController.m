...
- (void)viewDidLoad{
	...
	//Parse
	newsParser = [[MWFeedParser alloc] initWithFeedURL:kNewsFeedUrl];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	// Show detail
	NHNewsItemViewController *detailView = [self.storyboard instantiateViewControllerWithIdentifier:@"NewsItemController"];
